...
title: Simon
categories: [Projects]
tags: [robotics, hackathon, machine learning, hardware]
comments: true
---
...
_A visualization of the path planning which was done using a modified A\* search algorithm_
